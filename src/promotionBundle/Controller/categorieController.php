...
use promotionBundle\Entity\categorie;
...
class categorieController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $categories = $em->getRepository('promotionBundle:categorie')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('promotionBundle\Form\categorieType', $categorie);
    ...
    {
        $deleteForm = $this->createDeleteForm($categorie);
        $editForm = $this->createForm('promotionBundle\Form\categorieType', $categorie);
